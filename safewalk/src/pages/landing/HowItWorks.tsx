...
export function HowItWorks() {
  return (
    <section id="how" className="l-section" style={{ background: 'white' }}>
      <div className="l-inner">
        <div style={{ textAlign: 'center', maxWidth: 640, margin: '0 auto 56px' }}>
          <div style={{ fontSize: 13, fontWeight: 700, letterSpacing: 1.2, color: '#534AB7', marginBottom: 12 }}>HOW IT WORKS</div>
          <h2 className="l-h2">Three taps before you head out the door.</h2>
        </div>

        <div className="l-three-col">
          {steps.map(s => (
            <div key={s.n} style={{ background: 'white', borderRadius: 22, border: '1px solid rgba(127,119,221,0.15)', padding: 22, boxShadow: '0 4px 20px rgba(38,33,92,0.04)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                <span style={{ width: 28, height: 28, borderRadius: '50%', background: '#7F77DD', color: 'white', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, fontSize: 13 }}>{s.n}</span>
