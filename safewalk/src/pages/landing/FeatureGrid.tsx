...
export function FeatureGrid() {
  return (
    <section className="l-section" style={{ background: 'linear-gradient(180deg, #FAFAFE 0%, white 100%)' }}>
      <div className="l-inner">
        <div style={{ textAlign: 'center', maxWidth: 640, margin: '0 auto 56px' }}>
          <div style={{ fontSize: 13, fontWeight: 700, letterSpacing: 1.2, color: '#534AB7', marginBottom: 12 }}>FEATURES</div>
          <h2 className="l-h2">Everything you need.<br/>Nothing you don't.</h2>
        </div>
        ...
        <div className="l-feature-grid">
          {features.map((it, i) => (
            <div key={i} style={{ background: 'white', borderRadius: 18, padding: 24, border: '1px solid rgba(127,119,221,0.12)' }}>
              <div style={{ width: 48, height: 48, borderRadius: 14, background: '#EEEDFE', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
